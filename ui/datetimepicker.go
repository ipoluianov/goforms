...
type DateTimePicker struct {
	...
	DateTimeChanged func(event *Event)
}

func NewDateTimePicker(parent Widget) *DateTimePicker {
...
func (c *DateTimePicker) Draw(ctx DrawContext) {
	if c.checked_ {
...
func (c *DateTimePicker) KeyDown(event *KeyDownEvent) bool {
	return false
}
...
func (c *DateTimePicker) MouseDown(event *MouseDownEvent) {
	c.pressed = true
	c.Update("DateTimePicker")
}

func (c *DateTimePicker) MouseUp(event *MouseUpEvent) {
	if c.pressed {
		c.pressed = false
		c.Update("DateTimePicker")
...
func (c *DateTimePicker) MouseClick(event *MouseClickEvent) {
}
